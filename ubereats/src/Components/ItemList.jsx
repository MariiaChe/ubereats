    ...
    render(){
        ...
        return( 
            <React.Fragment>
              ...
              {Data.Pasillos.Lacteos[this.props.sub].map(el=><Item itemQuantity={this.props.itemQuantity} key={el.id} width="60%" addFirst={this.props.addFirst} subtractFromBasket={this.props.subtractFromBasket} addToBasket={this.props.addToBasket} imageItem={el.url} itemName={el.name} itemPrice={el.value}/>)}
